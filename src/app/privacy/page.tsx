  ...
  return (
    <div className="inner-page">
      ...
      <section className="page-content"><div className="container legal-shell"><aside><p>Privacy notice</p><strong>Last updated</strong><span>September 10, 2026</span></aside><article className="legal-card">
        ...
        <section><span>02</span><div><h2>Third-party services</h2><p>If Google Maps Platform services are enabled, search requests and resulting Places content are also subject to Google&apos;s applicable terms and privacy documentation.</p></div></section>
